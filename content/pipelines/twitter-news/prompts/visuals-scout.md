...
The segments JSON and media directory path are provided in your task message.
...
- Use output path like: `<media_dir>/seg-{position}.png` (where media_dir is from your task message)
